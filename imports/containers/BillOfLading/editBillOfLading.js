...
class SingleBillOfLadingEdit extends Component {
  onSave = () => {
                ...
                <div className="PageContent">
                  <div className="OrderInfo">
                    <div className="LeftSideContent">
                      <h3 className="Title">Bill of Lading Info</h3>
                      <Textfield
                        label="Number"
...
export default withStyles(styles, { withTheme: true })(SingleBillOfLadingEdit);
