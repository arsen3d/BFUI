...
import InvoicePageWrapper, { PrintIcon } from './singleBillOfLading.style';
...
class SingleBillOfLadingView extends Component {
  render() {
...
export default withStyles(styles, { withTheme: true })(SingleBillOfLadingView);
