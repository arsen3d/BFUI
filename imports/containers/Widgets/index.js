  ...
  render() {
    return (
      <LayoutWrapper>
        <Row>
          <HalfColumn>
            <SalesStats title="Containers" stretched />
          </HalfColumn>
        ...
        <Row>
          <HalfColumn md={12}>
            <Visitors title="Volume" stretched />
          </HalfColumn>
        ...
        <Row>
          <TwoThirdColumn sm={12} md={6}>
            <Contacts title="Contacts" widgetHeight={410} stretched />
          </TwoThirdColumn>
        ...
        <Row>
          <FullColumn>
            <TableWidget title="Drafts" />
          </FullColumn>
        </Row>
          <Row>
              <FullColumn>
                  <TableWidget title="In Progress" />
              </FullColumn>
          </Row>
          <Row>
              <FullColumn>
                  <TableWidget title="Pending" />
              </FullColumn>
          </Row>
        <Row>
